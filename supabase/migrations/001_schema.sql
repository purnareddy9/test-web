...
create policy "skills_auth_write"  on skills for all using (auth.role() = 'authenticated');
...
create policy "education_auth_write"  on education for all using (auth.role() = 'authenticated');
...
create policy "certifications_auth_write"  on certifications for all using (auth.role() = 'authenticated');
...
create policy "testimonials_public_read" on testimonials for select using (featured = true);
create policy "testimonials_auth_write"  on testimonials for all using (auth.role() = 'authenticated');
...
create policy "resume_public_read" on resume for select using (active = true);
create policy "resume_auth_write"  on resume for all using (auth.role() = 'authenticated');
...
create policy "portfolio_auth_write"  on storage.objects for all using (auth.role() = 'authenticated' and bucket_id = 'portfolio');
